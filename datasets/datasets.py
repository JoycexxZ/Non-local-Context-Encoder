...
class GeneralDataset(Dataset):
    ...
    def __getitem__(self, index):
        ...
        if self.dataset == "JPCL":
            image, mask = utils.get_data_JPCL(self.config.data_path, self.config.mask_path, name, use_adv=self.use_adv)
            ...
            image, mask = utils.get_data_ISBI(self.config.data_path, self.config.mask_path, name, use_adv=self.use_adv)
